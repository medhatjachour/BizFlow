                ...
                {showShiftForm && (
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-700/40 border border-slate-200 dark:border-slate-600 p-4 space-y-2">
                    ...
                    <div className="flex gap-2 pt-1">
                      <button onClick={saveShift} disabled={savingShift} className="flex-1 py-1.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium rounded-lg disabled:opacity-50">
