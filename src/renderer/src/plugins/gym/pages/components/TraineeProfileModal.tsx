                ...
                {showMeasForm && (
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-700/40 border border-slate-200 dark:border-slate-600 p-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button onClick={saveMeasurement} disabled={savingMeas} className="flex-1 py-1.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium rounded-lg disabled:opacity-50">
              ...
              <div className="space-y-3">
                ...
                {showGoalForm && (
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-700/40 border border-slate-200 dark:border-slate-600 p-4 space-y-2">
                    ...
                    <div className="flex gap-2">
                      <button onClick={saveGoal} disabled={savingGoal || !goalForm.title} className="flex-1 py-1.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-medium rounded-lg disabled:opacity-50">
