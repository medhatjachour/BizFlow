...
export default function GymPage() {
  ...
  const TABS: Array<{ key: Tab; label: string; icon: React.ElementType }> = [
    { key: 'attendance',    label: t('gymTabAttendance'),    icon: CalendarCheck2 },
    { key: 'trainees',      label: t('gymTabTrainees'),      icon: Users },
    { key: 'coaches',       label: t('gymTabCoaches'),       icon: UserCheck },
    { key: 'subscriptions', label: t('gymTabSubscriptions'), icon: CalendarCheck },
    { key: 'walkins',       label: t('gymTabWalkIns'),       icon: Footprints },
    { key: 'plans',         label: t('gymTabPlans'),         icon: ListChecks },
    { key: 'lockers',       label: t('gymTabLockers'),       icon: Lock },
    { key: 'programs',      label: t('gymTabPrograms'),      icon: ClipboardList },
  ]
