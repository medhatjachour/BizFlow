              ...
              {!useCustomYieldUnit ? (
                ...
                <div className="flex gap-1.5">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-amber-400 dark:border-amber-500 px-3 py-2 text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-400 transition-colors"
                  />
                  <button
                    type="button"
                    ...
                    <div className="grid grid-cols-12 gap-2 items-center">
                      <div className="col-span-4">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-slate-200 dark:border-slate-600 px-2 py-1.5 text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-400 transition-colors"
                        />
                      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full rounded-xl border border-slate-200 dark:border-slate-600 pl-6 pr-3 py-2 text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-colors"
                  />
                </div>
