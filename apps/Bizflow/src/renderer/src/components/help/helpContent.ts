    ...
    blocks: [
      {
        ...
        title: 'Work anywhere',
        keys: [
          { combo: 'Ctrl + K', text: 'Open the command palette and jump to any page by typing its name.' },
          { combo: 'Ctrl + R', text: 'Reload the window. Your data is not affected.' },
          { combo: 'Esc', text: 'Close a dialog or cancel what you are doing.' },
          { combo: 'Tab', text: 'Move between the fields of a form.' },
          { combo: 'Enter', text: 'Confirm the focused button.' },
        ],
      },
      {
        kind: 'keys',
        title: 'Selling and stock',
        keys: [
          { combo: 'Ctrl + N', text: 'Create a new item on the page you are on — product, customer, and so on.' },
          { combo: 'Ctrl + F', text: 'Show or hide the filters on a list.' },
          { combo: 'Ctrl + E', text: 'Export the list you are looking at.' },
          { combo: 'Ctrl + S', text: 'Save the form you are filling in.' },
          { combo: 'Up / Down arrows', text: 'Move through the highlighted list, such as the command palette.' },
        ],
      },
      {
        kind: 'callout',
        ...
        text: 'Once that is in your fingers you stop hunting through the sidebar. Press it, type a few letters of the page name, press Enter.',
      },
      {
        kind: 'text',
        text: 'A barcode scanner types far faster than any human ever will. With one plugged in you rarely need to touch the keyboard during a sale — just make sure the cursor is in a field that can accept it.',
      },
    ],
  },
]
