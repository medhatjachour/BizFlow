      ...
      {(preset === 'custom' || list.length === 1) && (
        <div className="flex items-center gap-1.5">
          ...
          <DateField value={from} onChange={changeFrom} wrapperClassName="w-36"
            className="px-2 py-1 text-xs border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]" />
