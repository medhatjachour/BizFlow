                ...
                <>
                  ...
                  <div>
                    ...
                    <select value={recipeId} onChange={e => setRecipeId(e.target.value)}
                      className="w-full rounded-xl border border-slate-200 dark:border-slate-600 px-3 py-2 text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)] transition-colors">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input type="number" min="0.01" step="0.01" value={quantity}
                        ...
                        className="flex-1 text-center rounded-xl border border-slate-200 dark:border-slate-600 px-3 py-2 text-base font-bold bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)] transition-colors" />
                      <button type="button"
                  ...
                  <div>
                    ...
                    <textarea rows={3} value={notes} onChange={e => setNotes(e.target.value)}
                      ...
                      className="w-full rounded-xl border border-slate-200 dark:border-slate-600 px-3 py-2 text-sm bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)] resize-none transition-colors" />
                  </div>
                </>
              )}
              </div>
