...
export const DeleteBatchConfirmModal: React.FC<Props> = ({ isOpen, onClose, onConfirm }) => {
  const { t } = useLanguage()
    ...
    >
      ...
      >
        ...
        <h3 className="text-base font-bold text-slate-900 dark:text-white">
          {t('bakeryDeleteBatchTitle') || 'Delete Production Batch'}
        </h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          {t('bakeryDeleteBatchConfirm') ||
            'Are you sure you want to delete this batch? Remaining unsold units will be removed from available inventory.'}
        </p>
