      ...
      <div className="p-4 space-y-4">
        ...
        {group.batches.length > 1 ? (
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-2 text-sm dark:bg-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]"
            >
              {group.batches.map(b => {
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 h-10 rounded-lg border border-slate-300 dark:border-slate-600 px-3 text-center text-base font-bold dark:bg-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]"
            />
            <button
              type="button"
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 dark:border-slate-600 pl-7 pr-3 py-2 text-sm dark:bg-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]"
            />
          </div>
        ...
        {showNotes && (
          <textarea
            ...
            className="w-full rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-2 text-sm dark:bg-slate-700 dark:text-white resize-none focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]"
          />
        )}
