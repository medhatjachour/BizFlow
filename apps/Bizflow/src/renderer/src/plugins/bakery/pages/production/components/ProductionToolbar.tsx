...
export const ProductionToolbar: React.FC<Props> = ({
  searchQuery,
  onSearchChange,
  onOpenLogModal,
}) => {
    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
      ...
      <div className="relative flex-1 min-w-[220px]">
        ...
        <input
          ...
          placeholder={t('bakerySearchProductionPlaceholder') || 'Search batches by recipe name or notes…'}
      ...
      >
        ...
        <span>{t('bakeryLogProduction') || 'Log Production Run'}</span>
      </button>
    </div>
  )
}