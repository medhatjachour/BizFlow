...
export const DeleteScheduleConfirmModal: React.FC<Props> = ({ isOpen, onClose, onConfirm }) => {
  const { t } = useLanguage()
    ...
    >
      ...
      >
        ...
        <h3 className="text-base font-bold text-slate-900 dark:text-white">
          {t('bakeryDeleteScheduleTitle') || 'Delete Production Schedule'}
        </h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          {t(
            'bakeryDeleteScheduleConfirm') || 'Are you sure you want to remove this scheduled production run? This action cannot be undone.'
          }
        </p>
