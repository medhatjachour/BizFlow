        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-52">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 pl-9 pr-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]"
            />
          </div>
                    ...
                    <div className="flex items-center gap-1 mt-auto">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="w-full pl-5 pr-1 py-1 rounded-lg border border-amber-300 dark:border-amber-700 text-xs dark:bg-slate-700 dark:text-white focus:outline-none focus:ring-1 focus:ring-[color:var(--accent)]"
                        />
                      </div>
              ...
              <form onSubmit={handleCustomSell} className="p-5 space-y-4">
                <div>
                  ...
                  <select value={customRecipeId} onChange={e => setCustomRecipeId(e.target.value)}
                    className="w-full rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-2 text-sm dark:bg-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="number" min="0" step="0.01" value={customPrice} onChange={e => setCustomPrice(e.target.value)} placeholder="0.00" required
                        className="w-full rounded-lg border border-slate-300 dark:border-slate-600 pl-6 pr-3 py-2 text-sm dark:bg-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]" />
                    </div>
                  </div>
                </div>
                ...
                <textarea value={customNotes} onChange={e => setCustomNotes(e.target.value)} rows={2} placeholder="Notes…"
                  className="w-full rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-2 text-sm dark:bg-slate-800 dark:text-white resize-none focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <select value={filterRecipe} onChange={e => { setFilterRecipe(e.target.value); setPage(1) }}
                      className="w-full rounded-lg border border-slate-300 dark:border-slate-600 px-2 py-1.5 text-sm dark:bg-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-[color:var(--accent)]">
