...
export const DeleteIngredientModal: React.FC<Props> = ({ isOpen, onClose, onConfirm }) => {
  const { t } = useLanguage()
    ...
    >
      ...
      >
        ...
        <h3 className="text-base font-bold text-slate-900 dark:text-white">
          {t('bakeryDeletePantryTitle') || 'Delete Ingredient'}
        </h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          {t('bakeryDeletePantryConfirm') ||
            'Are you sure you want to remove this ingredient from your pantry? Linked recipe ingredient references will remain.'}
        </p>
