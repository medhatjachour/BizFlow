    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white">{t('pharmacy')}</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">{t('phTodayOverview')}</p>
          </div>
        </div>
      ...
      {s.topProducts?.length > 0 && (
        <div className="bg-white dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
          <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-3">{t('phTopProducts')}</p>
